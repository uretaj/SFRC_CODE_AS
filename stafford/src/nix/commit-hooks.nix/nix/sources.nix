...
with rec
{
  pkgs =
    ...
    else import (builtins_fetchTarball {inherit (sources_nixpkgs) url sha256;}) {};
  ...
  callFunctionWith = autoArgs: f: args: let
...
# NOTE: spec must _not_ have an "outPath" attribute
  mapAttrs (
    _: spec:
      ...
      then spec // {outPath = callFunctionWith spec (getFetcher spec) {};}
      else spec
  )
  sources
