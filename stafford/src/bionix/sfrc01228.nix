  ...
  overlays = [
    (_: super: {
      mutsigs.decompose = _: _:
        super.pkgs.writeText "empty" "this file intentionally blank";
    })
  ];
}; let
  samples = [
    {
      prefix = "grimmond/s3/batch8/L1901033_S3";
      suffix = "_001";
      site = "S1";
      class = "tumours";
      sha256-1 = "bb31f923ce46b2e8fe5042ac4477b582533c2c438383764bc5cb30e13044ff4d";
      sha256-2 = "80eb5ccee1a0c203152bb6632970163ca452558a153a452682e9db64dbe4619f";
    }
    {
      prefix = "grimmond/s3/batch8/L1901033_topup_S4";
      suffix = "_001";
      site = "S1";
      class = "tumours";
      sha256-1 = "b5bdca0596a98fab8c2a834720c9834342f5e2adb6ebae2e43d9e160f6dc0cb4";
      sha256-2 = "e8de579b5a5ed0b7823d2f35554d9d7dfdd8d05d6d16540ae48e37cbf87b420f";
    }
    {
